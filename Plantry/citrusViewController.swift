//
//  citrusViewController.swift
//  Plantry
//
//  Created by Damilola Awofisayo on 10/30/21.
//

import UIKit

class citrusViewController: UIViewController {
    var firstRun = true

    /// A predictor instance that uses Vision and Core ML to generate prediction strings from a photo.
    let imagePredictor = CitrusPredictor()
...
extension citrusViewController {
...
extension citrusViewController {
    ...
    private func imagePredictionHandler(_ predictions: [CitrusPredictor.Prediction]?) {
    ...
    private func formatPredictions(_ predictions: [CitrusPredictor.Prediction]) -> [String] {
